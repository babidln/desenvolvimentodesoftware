...
public class ActionCalcular extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        double y = Double.parseDouble(txtX.getText()); 
        Calculadora calc = new Calculadora(x, y);
        if(cbxOperacao.getSelectedItem().equals("Soma")){
            JOptionPane.showMessageDialog(null, String.format("O resultado de %f + %f é %f", x, y. calc.somar()), "Calculadora Simples"),
            JOption
        }
    }
